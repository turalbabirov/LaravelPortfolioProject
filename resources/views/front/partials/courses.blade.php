            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="text-left">
                    ...
                    <div class="d-flex align-items-center">
                        <img class="img-fluid" src="{{asset('front/img/testimonial-1.jpg')}}" style="width: 60px; height: 60px;">
                        <div class="pl-3">
                ...
                <div class="text-left">
                    ...
                    <h4 class="text-body mb-4">Dolor eirmod diam stet kasd sed. Aliqu rebum est eos. Rebum elitr dolore et eos labore, stet justo sed est sed. Diam sed sed dolor stet accusam amet eirmod eos, labore diam clita</h4>
                    <div class="d-flex align-items-center">
                        <img class="img-fluid" src="{{asset('front/img/testimonial-2.jpg')}}" style="width: 60px; height: 60px;">
                        <div class="pl-3">
                            <h5 class="text-primary m-0">Client Name</h5>
                            <i>Profession</i>
                        </div>
                ...
                <div class="text-left">
                    ...
                    <h4 class="text-body mb-4">Dolor eirmod diam stet kasd sed. Aliqu rebum est eos. Rebum elitr dolore et eos labore, stet justo sed est sed. Diam sed sed dolor stet accusam amet eirmod eos, labore diam clita</h4>
                    <div class="d-flex align-items-center">
                        <img class="img-fluid" src="{{asset('front/img/testimonial-3.jpg')}}" style="width: 60px; height: 60px;">
                        <div class="pl-3">
                            <h5 class="text-primary m-0">Client Name</h5>
                            <i>Profession</i>
                        </div>
