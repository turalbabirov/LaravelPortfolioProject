<aside class="sidebar-nav-wrapper">
    <div class="navbar-logo">
        <a href="{{ route('index') }}">
            <img src="{{asset('admin_files/assets/images/logo/logo.svg')}}" alt="logo" />
        </a>
    </div>
    <nav class="sidebar-nav">
        <ul>
            <li class="nav-item nav-item-has-children">
              ...
              <span class="icon">
                ...
                <ul id="ddmenu_1" class="collapse show dropdown-nav">
                    <li>
                        <a href="{{ route('admin.index') }}" class="active"> eCommerce </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                <a href="#">
              <span class="icon">
                <svg viewBox="0 0 24 24" style="width:1.2000000000000002rem;height:1.2000000000000002rem" role="presentation"><path d="M11 15H17V17H11V15M9 7H7V9H9V7M11 13H17V11H11V13M11 9H17V7H11V9M9 11H7V13H9V11M21 5V19C21 20.1 20.1 21 19 21H5C3.9 21 3 20.1 3 19V5C3 3.9 3.9 3 5 3H19C20.1 3 21 3.9 21 5M19 5H5V19H19V5M9 15H7V17H9V15Z" style="fill:currentColor"></path></svg>
              </span>
                    <span class="text">Emeliyyat1</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="#">
              <span class="icon">
                <svg viewBox="0 0 24 24" style="width:1.2000000000000002rem;height:1.2000000000000002rem" role="presentation"><path d="M11 15H17V17H11V15M9 7H7V9H9V7M11 13H17V11H11V13M11 9H17V7H11V9M9 11H7V13H9V11M21 5V19C21 20.1 20.1 21 19 21H5C3.9 21 3 20.1 3 19V5C3 3.9 3.9 3 5 3H19C20.1 3 21 3.9 21 5M19 5H5V19H19V5M9 15H7V17H9V15Z" style="fill:currentColor"></path></svg>
                    ...
                    <span class="text">Emeliyyat2</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="#">
              <span class="icon">
                <svg viewBox="0 0 24 24" style="width:1.2000000000000002rem;height:1.2000000000000002rem" role="presentation"><path d="M11 15H17V17H11V15M9 7H7V9H9V7M11 13H17V11H11V13M11 9H17V7H11V9M9 11H7V13H9V11M21 5V19C21 20.1 20.1 21 19 21H5C3.9 21 3 20.1 3 19V5C3 3.9 3.9 3 5 3H19C20.1 3 21 3.9 21 5M19 5H5V19H19V5M9 15H7V17H9V15Z" style="fill:currentColor"></path></svg>
                    ...
                    <span class="text">Emeliyyat3</span>
                </a>
            </li>
            ...
            <li class="nav-item nav-item-has-children">
              ...
              <span class="icon">
                ...
                <ul id="ddmenu_2" class="collapse dropdown-nav">
                    ...
                    <li>
                        <a href="{{ route('admin.blankPage') }}"> Blank Page </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item nav-item-has-children">
              ...
              <span class="icon">
                ...
                <ul id="ddmenu_55" class="collapse dropdown-nav">
                    <li>
                        <a href="{{ route('admin.icons') }}"> LineIcons </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.mdiIcons') }}"> MDI Icons </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item nav-item-has-children">
              ...
              <span class="icon">
                ...
                <ul id="ddmenu_5" class="collapse dropdown-nav">
                    <li>
                        <a href="{{ route('admin.formElements') }}"> From Elements </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item">
